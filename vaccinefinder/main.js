...
var VaccineService = /** @class */ (function () {
    ...
    VaccineService.prototype.getVaccineInfoForNext7Days = function (districtId) {
        ...
        // let today = '29-5-2021';
        console.log(this.vaccineAPI + districtId + '&date=' + today);
...
var VaccineSlotComponent = /** @class */ (function () {
    ...
    VaccineSlotComponent.prototype.getVaccineInfo = function () {
        var _this = this;
        this.loading = true;
        console.log('Getting vaccine info for ditrcit ' + this.selectedstate);
        console.log('Getting vaccine info for ditrcit ' + this.selecteddistrict);
    ...
    VaccineSlotComponent.prototype.nextTen = function () {
        console.log('updated displayindex value ' + this.displayIndex);
        console.log('this.vaccineInfoResponse.length ' + this.filteredValues.length);
        this.vaccineInfo = this.filteredValues.slice(this.displayIndex, this.displayIndex + 10);
        console.log('displaying from ' + this.displayIndex + ' to ' + (this.displayIndex + 10));
    ...
    VaccineSlotComponent.prototype.prevTen = function () {
        ...
        console.log('display last 10 ' + prevNumber + " to " + (this.displayIndex - 10));
    ...
    VaccineSlotComponent.prototype.filterResults = function () {
        ...
        console.log(this.filteredVaccineType);
        ...
        if (this.filteredAge !== 'ALL') {
            ...
            console.log('Filtering by age ' + filteredResults.length);
        }
